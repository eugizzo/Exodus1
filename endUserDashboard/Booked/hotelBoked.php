...
// echo $emails;
$retrieve = "SELECT * FROM bookinghotel WHERE email='$emails'";
                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0 " id="example">
                                <thead>
                                    <tr class="bg-primary text-white">
                                        ...
                                        <th scope="col" class="col-sm-1">Number_room</th>
                                        <th scope="col" class="col-sm-1">phone_number</th>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($hotels->status == 0) {
                                                    if ($hotels->request == 0) {
                                                        echo '<button class="btn btn-warning" type="submit" name="Approved" id="statusBtn"><a class="text-white" href="hotelStatus.php?id=' . $hotels->id . '&request=2">Cancel</button>';
                                                    } else {
                                                        echo '<button class="btn btn-danger " type="submit" name="Approved" id="statusBtn"><a class="text-white" href="hotelStatus.php?id=' . $hotels->id . '&request=0">Cancelled</button>';
                                                    }
                                                } else {
                                                    echo '  ________ ';
                                                }
