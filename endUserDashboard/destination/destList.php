            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="post.php" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2 text-primary"></i>Post News</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            ...
                            <a href="destinationList.php" class="dropdown-item "><i class="fa fa-file me-2 text-primary"></i>destination List</a>
                            ...
                            ?>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit.php?id=<?= $destination->id; ?>" style="padding-right: 10px;"><img src="../img/edit.png" style="width:20px; height:auto;"></a>
                                            <a href="deleteUser.php?id=<?= $destination->id; ?>" onclick="return confirm('Are you sure you want to delete this user  with permission permanently? click Ok to continue or click Cancel')"><img src="../img/delete.png" style="width:30px; height:auto"></a>
                                        </td>
                                    </tr>
