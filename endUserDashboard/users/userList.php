            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="user1.png" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="../../index.php#destination" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2 text-primary"></i>Booking now</a>
                    <!-- <a href="#" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2 text-primary"></i>Profile</a> -->
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="user1.png" alt="" style="width: 40px; height: 40px;">
            ...
            <div>
                ...
                <div class="col-sm-10 " style="padding-top: 15px;">
                    <div class="bg-light rounded h-100 p-4">
                        <h3 class="mb-4" style="padding-top: 15px;"><i>My profile</i></h3>
