                            ...
                            <div class="place-cap">
                                ...
                                <div class="place-cap-bottom">
                                    <ul>
                                        ...
                                        <li><i class="fas fa-map-marker-alt"></i>Ter vive</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-place mb-30">
                            ...
                            <div class="place-cap">
                                ...
                                <div class="place-cap-bottom">
                                    <ul>
                                        <li><i class="far fa-clock"></i>3 Days</li>
                                        <li><i class="fas fa-map-marker-alt"></i>Jerusalem</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-place mb-30">
                            ...
                            <div class="place-cap">
                                ...
                                <div class="place-cap-bottom">
                                    <ul>
                                        <li><i class="far fa-clock"></i>3 Days</li>
                                        <li><i class="fas fa-map-marker-alt"></i>Jordan River</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-place mb-30">
                            ...
                            <div class="place-cap">
                                ...
                                <div class="place-cap-bottom">
                                    <ul>
                                        <li><i class="far fa-clock"></i>3 Days</li>
                                        <li><i class="fas fa-map-marker-alt"></i>Yudeya</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
