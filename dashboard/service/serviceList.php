        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle  active" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2 text-primary"></i>services</a>
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            <a href="services.php" class="dropdown-item "><i class="fa fa-plus-circle me-2 text-primary"></i>Addservice </a>
                            <a href="#" class="dropdown-item active"><i class="fa fa-file me-2 text-primary"></i>serviceList</a>
                        </div>
                    </div>
            ...
            <div>
                ...
                <div class="col-sm-12 " style="padding-top: 15px;">
                    <div class="bg-light rounded h-100 p-4">
                        <h3 class="mb-4" style="padding-top: 15px;"><i>Service list</i></h3>
                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0 "id="example">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <!-- <td><?= $destination->file_name; ?></td> -->

                                            <?php
                    // while($row = $query->fetch_assoc()){
       $imageURL = '../img/services/'.$destination->file_name;
                    // }    
                            ?>
                     
                     <td> <img src="<?php echo $imageURL; ?>" width=170px  /></td>
