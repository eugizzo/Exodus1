...
//   echo $id;
$update = "SELECT * FROM services WHERE id=$id";
...
if (isset($_POST['update'])) {
    ...
    if (file_exists('../img/services/' . $c_image)) {
        $filename = $_FILES['file']['name'];
        $_SESSION['status'] = 'image already Exist' . $filename;
        // header('Location:edit.php?id=<?=echo $id');
    } else {
        $c_update = "update services set title='$title', file_name='$update_c_image', description='$description'
	where id='$id'";
        ...
        if ($run_update) {
            ...
            if ($c_image != '') {
                move_uploaded_file($c_image_temp, "../img/services/$c_image");
                $trimed_path = trim('../img/services/' . $old_image);
                unlink($trimed_path);
            }

            $_SESSION['status'] = 'service update successful';
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 " style="padding-top: 10px;">
                    <div class="bg-light rounded h-100 p-4">
                        <h3 class="mb-4 text-primary">Update service</h3>
       ...
       $imageURL = '../img/services/'.$user->file_name;
                    // }    
                            ?>
                     <div class="form-floating mb-3">
                        <img src="<?php echo $imageURL; ?>" width=250px  />
                            ...
                            <div class="form-floating mb-3">
                            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="height: 150px;" name="description"><?= $user->description; ?></textarea>
