...
if (!isset($_SESSION['email'])) {
    ...
    header('location:../signup_pphone.php');
}
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-imphone me-2 text-primary"></i>Gallery</a>
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 " style="padding-left: 30px;">
                            <a href="hotels/hotelPphones.php" class="dropdown-item"><i class="fa fa-plus-circle me-2 text-primary "></i>Add Hotel </a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 " style="padding-left: 30px;">
                            <a href="blog/BlogPphone.php" class="dropdown-item  "><i class="fa fa-plus-circle me-2 text-primary "></i>Add Blog </a>
            ...
            <div class="row ">
                ...
                <div class="col-sm-6 " style="padding-top: 10px;">
                    <div class="bg-light rounded h-100 p-4">
                        <h3 class="mb-4 text-primary">Edit User</h3>
...
?>
                        ...
                        <input type="hidden" class="form-control" id="floatingInput" name="id" value="<?= $user->user_id; ?>">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" placeholder="news title" name="username" value="<?= $user->username; ?>">
                                <label for="floatingInput">userName</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control" id="floatingInputs" placeholder="news title" name="email" value="<?= $user->email; ?>">
                                <label for="floatingInput">Email</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="hidden" class="form-control" id="floatingInputss" placeholder="news title" name="password"  value="<?= $user->password; ?>">
                                <label for="floatingInput">Password</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingInputs" placeholder="published by" name="phone" value="<?= $user->phone; ?>">
