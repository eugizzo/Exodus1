...
$retrieve = "SELECT * FROM bookingHotel";
...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown"><i class="fa fa-calendar me-2 text-primary"></i>hotels</a>
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            <a href="../hotels/hotelPages.php" class="dropdown-item "><i class="fa fa-plus-circle me-2 text-primary"></i>Add hotels</a>
                            <a href="../hotels/hotelList.php" class="dropdown-item "><i class="fa fa-file me-2 text-primary"></i>hotels List</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 " style="padding-left: 30px;">
                            ...
                            <a href="../hotels/hotelPages.php" class="dropdown-item "><i class="fa fa-file me-2 text-primary"></i>Hotel list</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2 text-primary"></i>View booking</a>
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            <a href="../Booked/BookedDestination.php" class="dropdown-item "><i class="fa fa-plus-circle me-2 text-primary"></i>Tour Booking </a>
                            <a href="../Booked/BookedHotel.php" class="dropdown-item active"><i class="fa fa-file me-2 text-primary"></i>Hotel Booking</a>
            ...
            <div>
                ...
                <div class="col-sm-12 " style="padding-top: 15px;">
                    <div class="bg-light rounded h-100 p-3">
                        <h3 class="mb-4" style="padding-top: 15px;"><i> BOOKED HOTEL</i></h3>
                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0 " id="example">
                                <thead>
                                    <tr class="bg-primary text-white">
                                        ...
                                        <th scope="col" class="col-sm-2">Hotel Name</th>
                                        <!-- <th scope="col" class="text-primary">Location</th> -->

                                        <th scope="col" class="col-sm-1">Location/ nearBy</th>
                                        <!-- <th scope="col" class="text-primary col-sm-1">Email</th> -->
                                        <th scope="col" class="col-sm-1">Number room</th>
                                        <th scope="col" class="col-sm-1">Names</th>
                                        <th scope="col" class="col-sm-1">phone number</th>
                                        <th scope="col" class="col-sm-1">country</th>
                                        <th scope="col" class="col-sm-1">date</th>
                                        <th scope="col" class="col-sm-1">status</th>
                                        <th scope="col" class="col-sm-1">response</th>
                                ...
                                ?>
                                            ...
                                            <td><?= $hotels->numberOfroom; ?></td>
                                            <td><?= $hotels->fullName; ?></td>
                                            <td><?= $hotels->phone; ?></td>
                                            ...
                                            <td>
                                                ...
                                                if($hotels->request == 0){
                                                if ($hotels->status == 0) {
                                                    echo '<button class="btn btn-success" type="submit" name="Approved" id="statusBtn"><a class="text-white" href="hotelStatus.php?id=' . $hotels->id . '&status=1">Approve</button>';
                                                } else {
                                                    echo '<button class="btn btn-primary " type="submit" name="Approved" id="statusBtn"><a class="text-white" href="hotelStatus.php?id=' . $hotels->id . '&status=0">Desapprove</button>';
                                                }
                                            }
                                            else {
                                                echo '______';
                                            ...
                                            <td>
                                                ...
                                                <a href="hotelDelete.php?id=<?= $hotels->id; ?>" onclick="return confirm('Are you sure you want to delete this request  permanently? click Ok to continue or click Cancel')"><button class="btn btn-danger">Delete</button></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
    ...
    <script scr="status/custom-ajax.js" />
    </script>
