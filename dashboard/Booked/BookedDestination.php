                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 " style="padding-left: 30px;">
                            ...
                            <a href="../hotels/hotelPages.php" class="dropdown-item a"><i class="fa fa-file me-2 text-primary"></i>Hotel list</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            <a href="../Booked/BookedDestination.php" class="dropdown-item active "><i class="fa fa-plus-circle me-2 text-primary"></i>Tour Booking </a>
                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0" id="example">
                                <thead>
                                    <tr class="bg-primary text-white">
                                        ...
                                        <th scope="col" class="col-sm-2">Title/Location</th>
                                        ...
                                        <th scope="col" class="col-sm-1">request</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($destination->status == 0) {
                                                    echo '<button class="btn btn-success" type="submit" name="Approved" id="statusBtn"><a class="text-white" href="status.php?id=' . $destination->id . '&status=1">Approve</button>';
                                                } else {
                                                    echo '<button class="btn btn-primary " type="submit" name="Approved" id="statusBtn"><a class="text-white" href="status.php?id=' . $destination->id . '&status=0">Desapprove</button>';
                                                }}
                                                else {
                                                    echo '______';
                                                }
                                            ...
                                            <td>
                                                ...
                                                <a href="delete.php?id=<?= $destination->id; ?>" onclick="return confirm('Are you sure you want to delete this request  permanently? click Ok to continue or click Cancel')"><button class="btn btn-danger">Delete</button></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
