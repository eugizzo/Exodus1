        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="#" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2 text-primary"></i>Feedback</a>
            ...
            <div>
                ...
                <div class="col-sm-12 " style="padding-top: 15px;">
                    <div class="bg-light rounded h-100 p-4">
                        <h3 class="mb-4" style="padding-top: 15px;"><i>feedback</i></h3>
                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0 " id="example">
                                <thead>
                                    <tr class="bg-primary text-white">
                                        ...
                                        <th scope="col">comments from our followers</th>
