            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 " style="padding-left: 30px;">
                            <a href="hotelPages.php" class="dropdown-item "><i class="fa fa-plus-circle me-2 text-primary "></i>Add Hotel </a>
                            <a href="#" class="dropdown-item active"><i class="fa fa-file me-2 text-primary"></i>Hotel list</a>
            ...
            <div>
                ...
                <div class="col-sm-11 " style="padding-top: 15px;">
                    <div class="bg-light rounded h-100 p-4">
                        <h3 class="mb-4" style="padding-top: 15px;"><i>Hotels list</i></h3>
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0 " id="example">
                                <thead>
                                    ...
                                    <?php
                                $i = 0;
                                foreach ($feching as $key => $hotel) {
                                    $imageURL = '../img/HotelImages/' . $hotel->file_name;
                                    $i++;
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit.php?id=<?= $hotel->id; ?>" style="padding-right: 10px; color:green"><button class="btn btn-success">edit</button></a>
                                                <a href="delete.php?id=<?= $hotel->id; ?>" onclick="return confirm('Are you sure you want to delete this file with its details permanently? click Ok to continue or click Cancel')"><button class="btn btn-danger">delete</button></a>
