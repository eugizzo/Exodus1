 ...
 <nav class="navbar bg-light navbar-light">
        ...
        <div class="content">
            ...
            <div class="col-sm-6 " style="padding-top: 20px;">
                <div class="bg-light rounded h-100 p-4"  style="padding-top: 50px;" style="padding-bottom: 50px;">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary m-2">Add to Gallery</button>
                    </form>
                </div>
            </div>
            <div class="col-sm-3 " style="background-color: #f3f6f9;"></div>
