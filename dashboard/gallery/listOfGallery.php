...
<nav class="navbar bg-light navbar-light">
        ...
        <div class="d-flex align-items-center ms-4 mb-4">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-image me-2 text-primary"></i>Gallery</a>
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            <a href="insertGallery.php" class="nav-item nav-link "><i class="fa fa-plus-circle me-2 text-primary"></i> Add Gallery</a>
                            <a href="#" class="dropdown-item active"><i class="fa fa-file me-2 text-primary"></i>Gallery list</a>
           ...
           <div class="col-sm-1"></div>
            <div class="col-sm-10 "style="padding-top: 15px;">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4" style="padding-top: 15px;">List of Post</h6>
