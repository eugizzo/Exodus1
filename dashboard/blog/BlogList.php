...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            ...
                            <a href="../destination/destList.php" class="dropdown-item active"><i class="fa fa-file me-2 text-primary"></i>destination List</a>
            ...
            <div>
                ...
                <div class="col-sm-12 " style="padding-top: 15px;">
                    <div class="bg-light rounded h-100 p-4">
                        <h3 class="mb-4" style="padding-top: 15px;"><i>Blog list</i></h3>
       ...
       $imageURL = '../img/blog/'.$destination->file_name;
                    // }    
                            ?>
