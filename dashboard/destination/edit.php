...
$update = "SELECT * FROM destination WHERE id=$id";
            ...
            <div class="row">
                ...
                <div class="col-sm-6 " style="padding-top: 10px;">
                    <div class="bg-light rounded h-100 p-4">
                        <h3 class="mb-4 text-primary">Update destination</h3>
                        ...
                        <form method='POST' action="" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInputs" placeholder="published by" name="time" value="<?= $user->time; ?>">
