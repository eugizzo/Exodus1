            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            <a href="adduser.php" class="nav-item nav-link"><i class="fa fa-plus-circle me-2 text-primary"></i> Add Users</a>
                            <a href="#" class="dropdown-item active"><i class="fa fa-file me-2 text-primary"></i>UserList</a>
            ...
            <div>
                ...
                <div class="col-sm-10 " style="padding-top: 15px;">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4" style="padding-top: 15px;">List of user</h6>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td style="padding-left:60px;">
                                                <a href="edit.php?id=<?= $user->user_id; ?>" style="padding-right: 10px;"><button class="btn btn-primary">Edit</button></a>
                                                <a href="deleteUser.php?id=<?= $user->user_id; ?>" onclick="return confirm('Are you sure you want to delete this user  with permission permanently? click Ok to continue or click Cancel')"><button class="btn btn-danger">delete</button></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
